                                        ...
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                            ...
                                            @php $count = 0 @endphp
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div style=" border: 4px solid #e8e8f7;padding-left:10px;padding-bottom:10px;margin-bottom:10px;">
                                                        <input type="checkbox" class="ckbox mt-3 checkbox"
                                                            name="filter_id[]" value="{{ $value->id }}" >
                                                        <label style="padding-right:40px;" >
                                                           <b style="text-transform: capitalize;"> {{ $value->filter_title }}</b> 
                                                        </label><br>

                                                        @php
                                                        $filteroptions = App\Models\Filteroption::where('is_deleted', '<>', 1)->where('filter_id', $value->id)->get();
                                                        @endphp
