                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                            ...
                                            @php $count = 0 @endphp
                                                ...
                                                <div style=" border: 4px solid #e8e8f7;padding-left:10px;padding-bottom:10px;margin-bottom:10px; z-index: -1;">

                                                    <input type="checkbox" class="ckbox mt-3 checkbox" name="filter_id[]"
                                                        value="{{ $value->id }}"
