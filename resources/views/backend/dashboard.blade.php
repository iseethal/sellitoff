...
<div class="main-content side-content pt-0">
			...
			<div class="page-header">
				<div>
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="/dashboardd">Home</a></li>
		...
		<div class="row row-sm">
			<div class="col-sm-12 col-lg-12 col-xl-12">
							...
							<div class="card-body p-4">
								<div class="row align-items-center">
									<div class="offset-xl-3 offset-sm-6 col-xl-8 col-sm-6 col-12 img-bg ">
										...
										<p class="tx-white-7 mb-1">You have new open service requests </p>
									</div>
									<img src="backend/assets/img/pngs/work3.png" alt="user-img" class="wd-200">
								</div>
							</div>
						</div>
					</div>
                ...
                @php
                // $customer_count =  App\Models\Customer::where('status','<>',2)->count('id');
                @endphp
							...
							<div class="card-body">
								<div class="card-item">
									...
									<div class="card-item-title mb-2">
										<label class="main-content-label tx-13 font-weight-bold mb-1"><a href="{{ route('category.all') }}">Total Categories</a></label>
									</div>
        ...
        @php
        // $questions =  App\Models\Question::where('status','<>',2)->count('id');
        @endphp
					...
					<div class="card-body">
						<div class="card-item">
							...
							<div class="card-item-title mb-2">
								...
								<label class="main-content-label tx-13 font-weight-bold mb-1"><a href="{{ route('subcategory.all') }}"> Total Subcategories</a></label>

							</div>

							<div class="card-item-body">
								<div class="card-item-stat">
									<h4 class="font-weight-bold"> {{$subcategories}} </h4>
     ...
     @php
    //  $forms =  App\Models\Form::where('status','<>',2)->count('id');
     @endphp
				...
				<div class="card custom-card">
					<div class="card-body">
						<div class="card-item">
							...
							<div class="card-item-title  mb-2">
								<label class="main-content-label tx-13 font-weight-bold mb-1"><a href="{{ route('subsubcategory.all') }}">Total Sub-Subcategory</a></label>
							</div>


							<div class="card-item-body">
								<div class="card-item-stat">
									<h4 class="font-weight-bold"> {{ $sub_subcategories}} </h4>
         ...
         @php
        //  $reviews =  App\Models\Feedback::where('status','<>',2)->count('id');
         @endphp
					...
					<div class="card-body">
						<div class="card-item">
							...
							<div class="card-item-title mb-2">
								...
								<label class="main-content-label tx-13 font-weight-bold mb-1"><a href="{{ route('product.all') }}"> Total Products</a></label>
