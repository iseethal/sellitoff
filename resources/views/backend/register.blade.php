...
<!-- Mirrored from laravel.spruko.com/spruha/ltr/signup by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Nov 2022 05:01:15 GMT -->
                           ...
                           <form action="{{ route('register.store') }}" method="post">
                            @csrf
                                                ...
                                                <div class="form-group text-left">
													...
													<input class="form-control" placeholder="Enter your User_name" type="text" id="user_name" name="user_name">
												</div>
                                                <div class="form-group text-left">
