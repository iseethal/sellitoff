...
<div class="inner-body">
    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('subcategory.all')}}"> Subcategory</a></li>
                    ...
                    <div class="">
                        ...
                        {{-- <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="category_name" id="category_name" placeholder="Enter category name" type="text" required>
                            </div>
                        </div> --}}
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-8 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="subcategory_name" id="subcategory_name" placeholder="Enter subcategory name" type="text" required>
                            </div>
                        </div>
