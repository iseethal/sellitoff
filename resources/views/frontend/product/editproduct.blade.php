                ...
                <div class="col-xl-12">
                        ...
                        <div class="">
                            ...
                            @if (!$category_filter->isEmpty())
                                <div>
                                    <p style="text-align:left; font-size:16px;color:#ff9e00;" class="d-inline-block">
                                        <b>FILTERS</b>
                                    </p>
                            ...
                            <div class="row row-xs align-items-center mg-b-20 mb-4">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <input class="" name="price" id="price" value="{{ $product->price }}" placeholder="Enter price"  type="number" required>
                                </div>
                            </div>
                        ...
                        {{-- <div class="row row-xs align-items-center mg-b-20" >
                            ...
                            <div class="col-md-4 mg-t-5 mg-md-t-0">
                                ...
                                <label style="padding-right:40px;">
                                    <span style="text-transform: capitalize;">urgent</span>
                                </label>
                            ...
                            <div class="row row-xs align-items-center mg-b-20 mb-5">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <select class=" select select2" name="is_active" id="is_active" required>
                                        <option value="1"  @if($product->is_active =='1') selected='selected' @endif>Active</option>
                                        <option value="0" @if($product->is_active =='0') selected='selected' @endif>InActive</option>
                                        <option value="2" @if($product->is_active =='2') selected='selected' @endif>Sold</option>
                        ...
                        <div class="form-group row justify-content-end mb-4">
                            <div class="col-md-8 pl-md-2">
                                <input type="submit" value="Update" class="mt-4">
                            </div>
                        </div>
                </div>
