    ...
    <section class="gen-section-padding-3">
        <div class="container">
            <div class="row">
                ...
                @if (count($subcategoryallproducts) != 0)
                    @if (count($categoryfilter) > 0)
                        <div class="col-xl-3 col-md-12 order-1 order-xl-1 mt-4 mt-xl-0 pb-4">
                            ...
                            <div class="widget widget_recent_entries">
                                ...
                                <form action="{{ route('frontend.storesubcategoryallproducts', ['id' => Request()->id]) }}"
                                            ...
                                            <div class="col-md-12 mg-t-5 mg-md-t-0">
                                                ...
                                                @else
                                                    ...
                                                    @foreach ($filter_option_title as $val)
                                                        ...
                                                        <input type="checkbox" {{ $checked }} class="mt-3 checkbox" name="option_name[]" value="{{ $val->id }}">
                                                        <label style="padding-right:40px;">
                                                            <span style="text-transform: capitalize;">{{ $val->option_name }}</span></label><br>
                                                    @endforeach
                                                @endif
                                                @endforeach
                ...
                <div class="col-xl-9 col-md-12 order-2 order-xl-2 ">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            @foreach ($subcategoryallproducts as $item)
