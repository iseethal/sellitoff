    ...
    <section class="gen-section-padding-3">
        <div class="container">
            <div class="row">
                ...
                @if (count($subofsubcategoryallproducts) != 0)
                
                    @if (count($categoryfilter) > 0)

                        <div class="col-xl-3 col-md-12 order-1 order-xl-1 mt-4 mt-xl-0">

                            <div class="widget widget_recent_entries">
                                <h2 class="widget-title">Filters</h2>

                                <form
                                    action="{{ route('frontend.StoreSubofsubcategoryAllproducts', ['id' => Request()->id]) }}"
                                                    ...
                                                    @else
                                                        ...
                                                        @foreach ($filter_option_title as $val)
                                                            ...
                                                            @if (isset($optionname))
                                                                ...
                                                                @endif
                                                            @endif
                                                            <input type="checkbox" class="checkbox mt-3" {{ $checked }}
                            ...
                            <ul>
                                <li class="cat-item cat-item-1"><a href="blog-single.html">Uncategorized</a></li>
                            </ul>
                        </div> --}}
                ...
                @if (count($subofsubcategoryallproducts) == 0)
                    <div align="center"><b>No Products are available</b></div>
                @endif
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    @foreach ($subofsubcategoryallproducts as $item)
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6">
                                            <div class="gen-carousel-movies-style-3 movie-grid style-3"  @if(!$urgent_str) style="border:3px solid #d5e3f2; padding:10px;" @else style="border:3px solid rgba(158, 120, 6, 0.911); padding:10px;" @endif>
                                                ...
                                                <a
                                                    href="{{ route('frontend.product.singleproduct', ['id' => $item->id]) }}">
